...
function hoteller__welcome_dashboard_widget() {
 ...
 <div id="hoteller_-welcome-id" class="welcome-panel" style="display: none;">
  <div class="welcome-panel-content">
   ...
   <p class="about-description">Welcome to <?php echo esc_html(HOTELLER_THEMENAME); ?> theme. <?php echo esc_html(HOTELLER_THEMENAME); ?> is now installed and ready to use! Read below for additional informations. We hope you enjoy using the theme!</p>
   ...
   <div class="welcome-panel-column-container">
    ...
    <div class="one_half">
		...
		<div class="step_info">
			<?php echo esc_html(HOTELLER_THEMENAME); ?> has required and recommended plugins in order to build your website using layouts you saw on our demo site. We recommend you to install all plugins first.
		</div>
	</div>
	...
	<div class="one_half last">
		<div class="step_icon">
			<a href="<?php echo admin_url("themes.php?page=functions.php#pp_panel_ready-sites"); ?>">
				<i class="fas fa-cachebase"></i>
				<div class="step_title">Import Sites</div>
			</a>
		</div>
		<div class="step_info">
			We created various ready sites for you to use as starting point of your website. We recommend you to install all recommended plugins before importing ready site contents.
		</div>
	</div>
	...
	<div class="one_half last nomargin">
		<div class="step_icon">
			<a href="http://docs.themegoods.com/docs/hoteller" target="_blank">
...
function hoteller_remove_script_styles_version( $src ){
    return remove_query_arg( 'ver', $src );
}
add_filter( 'script_loader_src', 'hoteller_remove_script_styles_version' );
add_filter( 'style_loader_src', 'hoteller_remove_script_styles_version' );
