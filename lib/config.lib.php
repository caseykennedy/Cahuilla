	...
	$hoteller_page_postmetas_extended = 
		array (
			...
			*/
			...
			/*array(
    			"section" 		=> esc_html__('Page Attributes', 'hoteller' ), 
    			"id" 			=> "page_header_type", 
    			"type" 			=> "select", 
    			"title" 		=> esc_html__('Header Content Type', 'hoteller' ), 
    			"description" 	=> esc_html__('Select header content type for this page.', 'hoteller' ), 
				"items" 		=> array(
			...
			array(
				...
				"type" 			=> "text", 
				"title" 		=> esc_html__('Vimeo Video ID (Optional)', 'hoteller' ), 
				"description" 	=> esc_html__('Please enter Vimeo Video ID for example 73317780', 'hoteller' )
			),
			...
			array(
				...
				"type" 			=> "text", 
				"title" 		=> esc_html__('Youtube Video ID (Optional)', 'hoteller' ), 
				"description" 	=> esc_html__('Please enter Youtube Video ID for example 6AIdXisPqHc', 'hoteller' )
			),*/
